...
我们将推荐系统问题形式化为一个非稳态（non-stationary）contextual bandit问题。具体来说，非稳态contextual bandit问题可以通过一个元组 $(O, A, (V_t)_{t \in N}, (\theta_t)_{t \in N}, \rho)$ 来识别，其中:

-  $O$ 表示观察集合，
- $A$ 表示动作集合，
- $(V_t)_{t \in N}$ 表示决定非静态性的随机过程，
- $(\theta_t)_{t \in N}$ 表示决定上下文的随机过程，
