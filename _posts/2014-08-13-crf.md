...
<img src="http://www.forkosh.com/mathtex.cgi?p_{\theta}(y|x)=\frac{\prod_{i=1}^{n+1}M_i(y_{i-1},y_i|x}{(\prod{i=1}^{n+1}Mi(x))_{start,stop}}">
...
<img src="http://www.forkosh.com/mathtex.cgi?\alpha_\theta(y|x)=1">      (if y=start)

<img src="http://www.forkosh.com/mathtex.cgi?\alpha_\theta(y|x)=0">    (otherwise)
