...
<img src="http://www.forkosh.com/mathtex.cgi?\hat(E)(f_k)=\sum_{x,y}\hat{p}(x,y)\sum_{i=1}^{n+1}f_k(e_i,y|_{e_i},x)=\sum_{x,y}\hat{p}(x)p(y|x)\sum{i=1}{n+1}f_k(e_i,y|_{e_i},x)e^{\delta\lambda_kT(x,y)}">
