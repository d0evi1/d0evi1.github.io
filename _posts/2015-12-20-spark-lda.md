...
一个k维的Dirichlet随机变量θ，它的取值为(k-1)-simplex，(一个k维向量θ，它在(k-1)-simplex内，其中：<img src="http://www.forkosh.com/mathtex.cgi?\theta_i \geq 0, \sum_{i=1}^k\theta_i=1">) ，在该simplex上具有以下的概率密度：
