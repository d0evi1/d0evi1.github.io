...
$$
\begin{align}
\mathcal{L} (W,\phi,\gamma,\lambda) = \sum_{d} \{ E_q[log p(w_d | \theta_d,z_d,\beta)] + E_q [log p(z_d | \theta_d)] - E [logq(z_d)] \\
+ E [logp(\theta_d|\alpha)] - E [log q(\theta_d)] \\
+ ( E [logp(\beta |\eta)] - E [log q(\beta)])/D \}
\end{align}
$$ ......(3)
...
$$
\alpha \leftarrow \alpha - \rou_{t} \hat{\alpha}(\gamma_t)
$$

$$
\eta \leftarrow \rou_{t} \hat{\eta}(\lambda)
$$......(9)
