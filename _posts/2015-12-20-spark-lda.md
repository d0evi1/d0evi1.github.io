...
<img src="http://www.forkosh.com/mathtex.cgi?p(z_1,...,z_N)=p(z_{\pi(1)},...,z_{\pi(N)}">
...
<img src="http://www.forkosh.com/mathtex.cgi?p(W,z)=\int p(\theta) (\prod_{n=1}^{N} p(z_n|\theta) p(w_n|z_n)) d\theta">
...
<img src="http://www.forkosh.com/mathtex.cgi?q(\beta_{1:k},z_{1:M},\theta_{1:M}|\lambda,\phi,\gamma)=\prod_{i=1}^{k}Dir(\beta_i|\lambda_i) \prod_{d=1}^M q_d(\theta_d,z_d|\phi_d,\gamma_d)">
