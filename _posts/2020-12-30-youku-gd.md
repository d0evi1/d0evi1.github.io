...
$$
max g(X | \lambda) = \sum\limits_{i=1}^m \sum\limits_{j=1}^n    r_{ij} f(x_{ij}) + \lambda \frac{1}{\sum\limits_{i=1}^m (p_i - P)^2}{m-1}	\\
p_i = \frac{\sum\limits_{j=1}^n f(x_{ij})}{\frac{\sum\limits_{j=1}^n x_{ij}}}, \forall i \in \lbrace 1,2, \cdots, m \rbrace 	\\
