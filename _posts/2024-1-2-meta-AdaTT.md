...
我们简化NativeExpertLF模块以**验证AdaTT残差设计的重要性**，该设计包含分离的模块以融合不同的专家。我们还**可视化每个任务特定单元中学习的专家权重**，以展示AdaTT如何学习任务之间的适当交互，这对于有效的知识共享至关重要。最后，在第4.6节中，我们对AdaTT的超参数进行研究，以理解融合级别数量与专家数量之间的关系以及AdaTT的性能。
