...
除了高光时刻捕捉的挑战外，我们的直播模型还面临更严峻的问题：**数据稀疏性**。在滑动页面上，用户通过上下滑动屏幕可以交替观看短视频和直播内容。然而该页面**约90%的曝光内容为短视频**，导致直播推荐系统存在无法充分学习用户兴趣以进行精准CTR预测的风险。由此引出一个关键问题：如何利用用户丰富的短视频行为来优化直播推荐？
