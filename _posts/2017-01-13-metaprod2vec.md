...
- $$L_{I \mid M}$$：给定输入商品的元信息M，输入商品id的条件概率，以及预测的条件概率间的加权交叉熵
- $$L_{J \mid M}$$: 给定输入商品的元信息M，它的下下文商品id的条件概率，与预测条件概率间的加权交叉熵
- $$L_{M \mid I}$$: 给定输入商品I，它的上下文商品元信息值M的条件概率、与预测的条件概率，它们间的加权交叉熵
- $$L_{M \mid M}$$: 给定输入商品的元信息M，它的上下文商品元信息值M的条件概率，与预测的条件概率间的加权交叉熵。
